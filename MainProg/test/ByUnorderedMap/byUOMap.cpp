...
class myDatabase{
private:
	unordered_map<string, map<int,int> > Database;
	/*
...
void myDatabase::printAll(){
	for(unordered_map<string, map<int,int> >::iterator it = Database.begin(); it != Database.end();it++){
		cout<<it->first<<endl;
...
void myDatabase::setUpDatabase(string word, int i){
	unordered_map<string, map<int,int> >::iterator it;
